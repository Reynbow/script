...
gui Font,,Wingdings
gui Add,Button,xp yp wp     gVScrollUp,             �
gui Add,Button,x+0 wp hp    gVScrollDn,             �
gui Font
gui Add,Button,x+0 wp hp    gVScrollPageUp,         Page Up
gui Add,Button,x+0 wp hp    gVScrollPageDn,         Page Dn

gui Font,,Wingdings
gui Add,Button,xm wp hp     gHScrollLeft,           �
gui Add,Button,x+0 wp hp    gHScrollRight,          �
gui Font
gui Add,Button,x+0 wp hp    gHScrollPageLeft,       Page Left
gui Add,Button,x+0 wp hp    gHScrollPageRight,      Page Right

gui Font,,Wingdings
gui Add,Button,xm  wp hp    gTop,                   �
gui Add,Button,x+0 wp hp    gBottom,                �
gui Add,Button,xm  wp hp    gLeft,                  �
gui Add,Button,x+0 wp hp    gRight,                 �
gui Add,Button,xm  wp hp    gLeftTop,               �
gui Add,Button,x+0 wp hp    gRightTop,              �
gui Add,Button,xm  wp hp    gLeftBottom,            �
gui Add,Button,x+0 wp hp    gRightBottom,           �
gui Font
