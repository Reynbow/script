...
XL.Range("A4").Value := "Jim"
XL.Range("A5").Value := "Joel"
XL.Range("A6").Value := "Renae"
XL.Range("A7").Value := "Rick"
...
XL.Range("B4").Value := JimTotal
XL.Range("B5").Value := JoelTotal
XL.Range("B6").Value := RenaeTotal
XL.Range("B7").Value := RickTotal
;XL.Range("B3").Value := CraigTotal
;XL.Range("B7").Value := JoshTotal

XL.Range("A1:B7").Select
...
Data_Source=
(
 -Aaron-Brodie-James-Joel-Renae-Rick
Monday-%AaronMon%-%BrodieMon%-%JimMon%-%JoelMon%-%RenaeMon%-%RickMon%
Tuesday-%AaronTue%-%BrodieTue%-%JimTue%-%JoelTue%-%RenaeTue%-%RickTue%
Wednesday-%AaronWed%-%BrodieWed%-%JimWed%-%JoelWed%-%RenaeWed%-%RickWed%
Thursday-%AaronThu%-%BrodieThu%-%JimThu%-%JoelThu%-%RenaeThu%-%RickThu%
Friday-%AaronFri%-%BrodieFri%-%JimFri%-%JoelFri%-%RenaeFri%-%RickFri%
 - - - - - - - -
TOTAL-%AaronTotal%-%BrodieTotal%-%JimTotal%-%JoelTotal%-%RenaeTotal%-%RickTotal%
)	
; Call the function 
